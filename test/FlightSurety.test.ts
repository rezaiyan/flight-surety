...
describe('FlightSuretyApp', function () {
    let flightSuretyApp: any;
    let deployer: HardhatEthersSigner;
    let airlines: IAirline[] = [];
    let oracles: IOracle[] = [];
    let passengerAccount: HardhatEthersSigner;
    ...
    describe('FlightSuretyApp Airline Registration', function () {
        ...
        const registerAndFundAirline = async (airlineToRegister: IAirline, registeredBy: IAirline) => {
        ...
        const expectAirlineRegistration = async (airline: IAirline, expected: boolean, message: string) => {
        ...
        it('reaches consensus when required number of airlines vote', async function () {
            ...
            const voteForAirline = async (voter: IAirline, targetAirlineAddress: string) => {
    ...
    describe('FlightSuretyApp Flight and Insurance Management', function () {
        ...
        const buyInsurance = async (amount: string) => {
    ...
    describe("FlightSuretyApp Oracle Logic", function () {
        ...
        it("oracles can submit responses and process flight status", async function () {
            ...
            let requestIndex;
            flightSuretyApp.on("OracleRequest", (index: [], airlin: string, flight: string, timestamp: Number) => {
                requestIndex = index;
            });
